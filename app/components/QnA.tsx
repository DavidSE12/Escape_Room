			...
			<div className="relative w-[1000px] h-[560px]">
				...
				<div className="absolute inset-0 flex flex-col justify-center items-center px-12 pt-16">
					...
					<div className="w-full mb-2">
						<label className="block text-sm text-slate-700 mb-1">{isCreate ? "Correct answer" : "Your answer"}</label>
						<input
					...
					<div className="flex gap-3 mt-6 self-start">
						{isCreate ? (
							<button
								onClick={() => onCreate?.({ question: newQuestion.trim(), answer: newAnswer.trim(), hint: newHint.trim() || undefined })}
